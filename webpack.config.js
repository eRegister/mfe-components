...
const federationConfig = {
  ...
  output: {
    ...
    publicPath: "/CHANGE_TO_YOUR_ACTUAL_PROXY_PATH/",
  },
  // devServer: {},
  plugins: [
    ...commonConfig.plugins,
    new ModuleFederationPlugin({
      // SETUP TODO: CHANGE THIS TO A PROPER NAME
      name: "bahmni_MFE_NAME",
      filename: "remoteEntry.js",
      exposes: {
        // SETUP TODO: Correct these
        "./EntryComponent1":
          "./src/entries/EntryComponent1/EntryComponent1.jsx",
        "./EntryComponent1":
          "./src/entries/EntryComponent2/EntryComponent2.jsx",
      },
      shared: {
        // ...dependencies,
        "carbon-components": {
